"""
Data Preparation Module for NegaPriceNL Project

Merges all data sources (prices, generation, weather, forecasts) into a unified
modeling dataset with proper time alignment and quality checks.

This script:
1. Loads all available data sources
2. Aligns them on a common hourly time index
3. Performs quality checks and reports anomalies
4. Creates target variable (negative price indicator)
5. Saves the unified dataset for feature engineering
"""
...
class DataPreparation:
    """
    Unified data preparation pipeline for NegaPriceNL project.
    """
    ...
    def __init__(self):
        ...
        logger.info("DataPreparation pipeline initialized")
    ...
    def run(self) -> pd.DataFrame:
        ...
        logger.info("\n" + "="*70)
        logger.info("NEGAPRICENL DATA PREPARATION PIPELINE")
        logger.info("="*70)
